...
[![Streamlit](https://img.shields.io/badge/Streamlit-App-red?logo=streamlit)](https://policy-evaluation-engine-gabrielthomas.streamlit.app/) •
...
* **Immunity to Prompt Injection:** Naive LLM implementations process untrusted user text as executable code. This architecture implements a strict **Defensive Enclosure Boundary** that treats input text strictly as informational data, defeating jailbreak, social engineering, and behavioral override exploits.
